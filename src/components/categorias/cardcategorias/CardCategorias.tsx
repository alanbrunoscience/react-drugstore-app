...
function CardCategorias({ categoria }: CardCategoriaProps) {
  return (
    <div className='flex flex-col justify-between overflow-hidden border rounded-2xl'>
      <header className='px-6 py-2 text-2xl font-bold text-white bg-slate-500'>
        Categoria
      </header>
      ...
      <div className="flex">
        ...
        <Link to={`/deletarcategoria/${categoria.id}`}
          className='flex items-center justify-center w-full bg-red-400 text-slate-50 hover:bg-red-800'>
